...
function wp_check_php_mysql_versions() {
	...
	if ( !extension_loaded( 'mysql' ) && !file_exists( WP_CONTENT_DIR . '/db.php' ) )
		die( /*WP_I18N_OLD_MYSQL*/'PHP에 MySQL 확장이 설치되어 있지 않은 것 같습니다. 워드프레스는 이 확장이 필요합니다.'/*/WP_I18N_OLD_MYSQL*/ );
}
...
function wp_set_wpdb_vars() {
	...
	if ( is_wp_error( $prefix ) )
		wp_die( /*WP_I18N_BAD_PREFIX*/'<strong>오류</strong>:  <code>wp-config.php</code>의 <code>$table_prefix</code>는 반드시 영문자, 숫자와 _로만 이뤄져야 합니다.'/*/WP_I18N_BAD_PREFIX*/ );
}
